...
namespace DataAccess.Migrations
{
    ...
    [Migration("20220326163506_RemovePluralFromWatchedAndWishListAccounts")]
    partial class RemovePluralFromWatchedAndWishListAccounts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountMovie", b =>
                {
                    b.Property<int>("WatchedListAccountId")
                        .HasColumnType("int");

                    b.Property<int>("WatchedListId")
                        .HasColumnType("int");

                    b.HasKey("WatchedListAccountId", "WatchedListId");
            ...
            modelBuilder.Entity("AccountMovie1", b =>
                {
                    b.Property<int>("WishListAccountId")
                        .HasColumnType("int");

                    b.Property<int>("WishListId")
                        .HasColumnType("int");

                    b.HasKey("WishListAccountId", "WishListId");
            ...
            modelBuilder.Entity("AccountMovie", b =>
                {
                    b.HasOne("DataAccess.Models.Account", null)
                        .WithMany()
                        .HasForeignKey("WatchedListAccountId")
            ...
            modelBuilder.Entity("AccountMovie1", b =>
                {
                    b.HasOne("DataAccess.Models.Account", null)
                        .WithMany()
                        .HasForeignKey("WishListAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
